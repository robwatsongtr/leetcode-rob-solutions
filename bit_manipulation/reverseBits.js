...
var reverseBits = function(n) { 
  ...
  for( let i = 0; i < 32; i++ ) {
    ...
    // read from the LSB by ANDing with 1 then bit shift to next place,
    // use >>> for unsigned right shift in JS
    let bit = (n >>> i) & 1 

    // write the bit in reverse starting at result's MSB using OR 

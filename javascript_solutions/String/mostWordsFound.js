...
var mostWordsFound = function(sentences) {
  ...
  // step 1, create a function that counts the number of words in a string
  function numWords(str) {
    const words = str.split(' ') // create an array of words 
    let count = 0
  ...
  // step two, loop through array of sentences
  let maxCount = 0
  for( let i = 0; i < sentences.length; i++) {
    let currentCount = numWords(sentences[i])
...
console.log( mostWordsFound(["alice and bob love", "i think so too", "this is great thanks"]))
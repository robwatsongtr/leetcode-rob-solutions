...
def choose_random_150():
    easy_list = [
        88, 27, 26, 169, 121, 13, 58, 14, 28, 125, 392, 383, 290, 242, 1, 219, 202, 205, 228, 20, 412, 70, 2418
    ]
    ...
    array_list_easy = [
        88, 27, 26, 169, 121, 13, 58, 14, 28, 125, 392, 228, 20, 944, 704, 35, 13, 28, 392, 412
    ]
    ...
    medium_list = [
        3, 209, 122, 55, 150, 12, 134, 238, 80, 167, 189, 151, 146, 380, 53, 49, 200, 515, 56 
    ]
